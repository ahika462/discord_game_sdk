...
HX_DEFINE_STACK_FRAME(_hx_pos_7ff51de226ebc807_59_new,"discord.Core","new",0x1bbb44f3,"discord.Core.new","discord/Core.hx",59,0x605a4bfc)
HX_LOCAL_STACK_FRAME(_hx_pos_7ff51de226ebc807_52_destroy,"discord.Core","destroy",0x9e9ee70d,"discord.Core.destroy","discord/Core.hx",52,0x605a4bfc)
HX_LOCAL_STACK_FRAME(_hx_pos_7ff51de226ebc807_56_runCallbacks,"discord.Core","runCallbacks",0xfe450b50,"discord.Core.runCallbacks","discord/Core.hx",56,0x605a4bfc)
HX_LOCAL_STACK_FRAME(_hx_pos_7ff51de226ebc807_63_get_activityManager,"discord.Core","get_activityManager",0xe5164e08,"discord.Core.get_activityManager","discord/Core.hx",63,0x605a4bfc)
HX_LOCAL_STACK_FRAME(_hx_pos_7ff51de226ebc807_45_create,"discord.Core","create",0x48f2d049,"discord.Core.create","discord/Core.hx",45,0x605a4bfc)
namespace discord{

void Core_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7ff51de226ebc807_59_new)
HXDLIN(  59)		this->_activityManager =  ::discord::ActivityManager_obj::__alloc( HX_CTX );
            	}
...
void Core_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_7ff51de226ebc807_52_destroy)
            	if (internal_) {
...
int Core_obj::runCallbacks(){
            	HX_STACKFRAME(&_hx_pos_7ff51de226ebc807_56_runCallbacks)
...
HX_DEFINE_DYNAMIC_FUNC0(Core_obj,runCallbacks,return )
 ...
 ::discord::ActivityManager Core_obj::get_activityManager(){
            	HX_STACKFRAME(&_hx_pos_7ff51de226ebc807_63_get_activityManager)
            	_activityManager->internal_ = internal_->get_activity_manager(internal_);

HXDLIN(  63)		return this->_activityManager;
            	}
...
int Core_obj::create(::cpp::Int64 clientID,::cpp::UInt64 flags, ::discord::Core instance){
            	HX_STACKFRAME(&_hx_pos_7ff51de226ebc807_45_create)
